...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
	 ...
	 * {@linkhandmark.pulltorefresh.library.PullToRefreshBase.Mode#PULL_FROM_START}. The default value is <var>true</var> if
	 * {@linhandmark.pulltorefresh.library.PullToRefreshBase#isPullToRefreshOverScrollEnabled()
	...
	/**
	 * Pass-through method for {handmark.pulltorefresh.library.PullToRefreshBase#getRefreshableView()
	 * getRefreshableView()}.
	...
	/**
	 * Pass-through method for {@linkhandmark.pulltorefresh.library.PullToRefreshBase#getRefreshableView()
	 * getRefreshableView()}.
	 ...
	 * a state where a Pull-to-Refresh can happen. An example of this state is
	 * when the Adapter View is scrolled to the top and the mode is set to
	 * {@linhandmark.pulltorefresh.library.PullToRefreshBase.Mode#PULL_FROM_START}
	 * 
