...
import pulltorefresh.internal.FlipLoadingLayout;
import pulltorefresh.internal.LoadingLayout;
import pulltorefresh.internal.RotateLoadingLayout;
import pulltorefresh.internal.Utils;
import pulltorefresh.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	/**
	 * @return Either {handmark.pulltorefresh.library.PullToRefreshBase.Orientation#VERTICAL} or
	 *         {handmark.pulltorefresh.library.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
	 */
	 ...
	 * {@linhandmark.pulltorefresh.library.PullToRefreshBase.State#PULL_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@lihandmark.pulltorefresh.library.PullToRefreshBase.State#REFRESHING} or {@link com.handmark.pulltorefresh.library.PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 * 
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {handmark.pulltorefresh.library.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
	 */
	...
	public static enum Mode {
		 ...
		 * {handmark.pulltorefresh.library.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction - One of {handmark.pulltorefresh.library.PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@handmark.pulltorefresh.library.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is
		 *            {handmark.pulltorefresh.library.PullToRefreshBase.State#PULL_TO_REFRESH} or
		 *            {handmark.pulltorefresh.library.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
		 */
