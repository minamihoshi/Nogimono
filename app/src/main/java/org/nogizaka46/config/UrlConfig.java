...
public class UrlConfig {
    ...
    public static  final  String BASE_FORMATWEB ="https://platform.idolx46.top";

    public static final  String VERSION_CHECK ="https://platform.idolx46.top/check/version/android";
