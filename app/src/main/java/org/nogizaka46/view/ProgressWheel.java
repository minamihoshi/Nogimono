...
public class ProgressWheel extends View {
    ...
    /**
     * Use onSizeChanged instead of onAttachedToWindow to get the dimensions of the org.nogizaka46.view,
    ...
    /**
     * Parse the attributes passed to the org.nogizaka46.view from the XML
     *
    ...
    /**
     * Puts the org.nogizaka46.view on spin mode
     */
    public void spin() {
        lastTimeAnimated = SystemClock.uptimeMillis();
        isSpinning = true;
    ...
    // Great way to save a org.nogizaka46.view's state http://stackoverflow.com/a/7089687/1991053
    @Override
