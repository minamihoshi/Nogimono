...
import org.nogizaka46.utils.DisplayUtil;
...
public class WaveSwipeRefreshLayout extends ViewGroup
  ...
  @Override public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    //// Propagates measuring to child org.nogizaka46.view and to circle org.nogizaka46.view

    // Measures on child org.nogizaka46.view with each directed length without padding
    mTarget.measure(
  ...
  /**
   * Make circle org.nogizaka46.view be visible and even scale.
   */
  ...
  private void ensureTarget() {
    ...
    if (mTarget == null) {
      throw new IllegalStateException("This org.nogizaka46.view must have at least one AbsListView");
    }
  }
  ...
  /**
   * Custom org.nogizaka46.view has progress drawable.
